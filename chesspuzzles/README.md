# Chesshook2
### The ultimate chess.com puzzle-solving software

## Disclaimer, some words
This tool should not be used against the terms of service of chess.com or anything, use at your own risk. The software 
is provided for reference purposes only, as a sort of reverse engineering project. I provide no guarantees on what will
happen if you choose to use this software.  

Your account will probably be shadowbanned from leaderboards, I'm not sure how much the "legit" features of this
software help with that (I got banned after being #1 for some time but at the time I had solved everything with a 
duration of 0:00 ¯\\\_(ツ)\_/¯). AFAIK chess.com won't ban your account unless you cheat against other players.
